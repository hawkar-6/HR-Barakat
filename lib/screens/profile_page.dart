...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        title: const Text("پڕۆفایل", style: TextStyle(color: Colors.greenAccent)),
        centerTitle: true,
      ),
      body: Column(
        children: [
          ...
          const Text("ڕەوەند عەلی", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
